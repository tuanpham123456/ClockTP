                    ...
                    <table class="table data-thumb-view">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="product-name">{{ $category->c_name }}</td>

                                <td>
                                    @if ($category->c_status == 1 )
                                    <div class="chip chip-warning">
                                        <div class="chip-body">
                                            <div class="chip-text"><a style="color: antiquewhite" href="{{ route('admin.category.active',$category->id) }}">Hide</a></div>
                                        </div>
                                    </div>
                                    @else
                                    <div class="chip chip-warning">
                                        <div class="chip-body">
                                            <div class="chip-text"><a style="color: antiquewhite" href={{  route('admin.category.active',$category->id) }} }} >Show</a></div>
                                        </div>
                                    </div>
                                ...
                                <td>
                                    ...
                                    <div class="chip chip-warning">
                                        <div class="chip-body">
                                            <div class="chip-text"><a style="color: antiquewhite" href="{{ route('admin.category.hot',$category->id) }}">Hot</a></div>
                                        </div>
                                    </div>
                                    @else
                                    <div class="chip chip-warning">
                                        <div class="chip-body">
                                            <div class="chip-text"><a style="color: antiquewhite" href="{{ route('admin.category.hot',$category->id) }}">No</a></div>
                                        </div>
                                    </div>
