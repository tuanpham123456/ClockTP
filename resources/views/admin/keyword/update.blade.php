                                        ...
                                        <div class="row">
                                            <div class="col-xl-12 col-md-12 col-12 mb-1">
                                                <fieldset class="form-group" ></fieldset>
                                                    ...
                                                    <input type="text" name="k_name" value="{{ $keywords->k_name }}" class="form-control" id="" placeholder="Enter email" >
                                            ...
                                            <div class="col-xl-12 col-md-12 col-12 mb-1">
                                                <fieldset class="form-group">
                                                    <textarea class="form-control" id="basicTextarea" name="k_description" rows="3" placeholder="Textarea">{{ $keywords->k_description }}</textarea>
                                                </fieldset>
                                            ...
                                            <div class="col-xl-6 col-md-8 offset-md-4">
                                                ...
                                                <button type="" class="btn btn-outline-warning mr-1 mb-1"><a href="{{ route('admin.keyword.index') }}">Back</a></button>
                                            </div>
